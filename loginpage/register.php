    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            ...
            if ($result) {
                ...
                echo "<script>alert('Woops! Terjadi kesalahan.');window.location = 'index.php';</script>";
            }
        } else {
            echo "<script>alert('Woops! Email Sudah Terdaftar.');window.location = 'index.php';</script>";
        }
    } else {
